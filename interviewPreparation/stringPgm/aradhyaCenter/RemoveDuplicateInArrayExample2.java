...
//    for (int i=0; i<n; i++){
//        // arr[i] = temp[i];
//        System.out.println("printing original array before modification  " +arr[i]);
//    }
        ...
        // here array temp contains the index 10,20,30,0,0
        // we need to consider index until the value 'j' index. It iterated the value from index 0 to 3.
    ...
    public static void main (String[] args) {
        ...
        System.out.println( " "+"\n");
        int newarray[] = removeDuplicateElements(arr);
